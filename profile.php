...
<section class="user-details">
   <div class="user">
      ...
      <p><i class="fas fa-user"></i><?php if(isset($fetch)){ echo $fetch['name']; } ?></p>
      <p><i class="fas fa-phone"></i> <?php if(isset($fetch)){ echo $fetch['mobile']; } ?></p>
      <p><i class="fas fa-envelope"></i> <?php if(isset($fetch)){ echo $fetch['email']; } ?></p>
